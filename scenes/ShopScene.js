class ShopScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.ballData = [
            ...
            { id: 'fire', name: 'Fireball', price: 100, ability: '+2 score per deflect', texture: 'ball_fire' },
            { id: 'steel', name: 'Steel Ball', price: 200, ability: 'Ball moves 10% slower', texture: 'ball_steel' },
